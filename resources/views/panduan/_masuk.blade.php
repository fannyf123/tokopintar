<div class="tab-pane fade" id="tab-masuk">
    ...
    <div class="panduan-step">
        <span class="step-num">6</span> Di halaman detail, klik <strong>Terima Barang</strong> (hijau) → stok otomatis bertambah ke daftar barang.
    </div>

    <div class="panduan-tip">
        💡 <strong>Kenapa pakai sistem Draft → Terima?</strong><br>
        Saat input awal jadi <strong>Draft</strong>, stok belum nambah. Kalau ada salah ketik, masih bisa Batal. Setelah barang fisik benar-benar masuk gudang, baru klik <strong>Terima Barang</strong> → stok masuk resmi.
    </div>
</div>
