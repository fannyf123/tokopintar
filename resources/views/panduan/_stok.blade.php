<div class="tab-pane fade" id="tab-stok">
    <h4 class="fw-bold mb-3"><i class="fas fa-exchange-alt text-primary me-2"></i>Penyesuaian Stok</h4>
    <p class="text-muted">Untuk koreksi stok yang tidak melalui jualan/pembelian normal.</p>

    <h6 class="fw-bold mt-4 mb-2">Kapan Pakai Penyesuaian Stok?</h6>
    <ul>
        <li>Barang <strong>rusak</strong> saat dibongkar (misal botol pecah)</li>
        <li>Barang <strong>hilang</strong> setelah opname</li>
